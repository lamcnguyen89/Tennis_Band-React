  ...
  return (
    <div className="background-album">
      ...
      <main className="container p-2 my-4">
        ...
        <h4>
          <a
            href="https://www.amazon.com/dp/B00FYTPKMU/ref=ntt_mus_ep_dpi_6"
            target="_blank"
            rel="noreferrer"
            alt="All Tennis's Music"
          >
            Purchase Small Sound Here!
          </a>
        </h4>
        <hr />
        <div className="row">
          ...
          <div className="col-8">
            <div className="tab-content" id="nav-tabContent">
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/dEGRG-ggA-o"
                    frameborder="0"
                ...
                <div className="container mt-3">
                  <p>
                    Summerin' in the Catskills, baby <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/hXoVlVBcdC4"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Jot something down on a list <br />
                  ...
                  <p>
                    ...
                    <br />
                    Sai it slowly until you believe
                    <br />
                  ...
                  <p>
                    ...
                    It's wrong, I know
                    <br />
                    I can't let go Timothy, say something sweet to me
                    <br />
                    Say it slowly until you believe
                    <br />
                    Tell me that you find increasingly
              ...
              >
                <h3>Cured of Youth</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/o05i-fzwzZc"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  ...
                  <p>
                    ...
                    Here's your one chance
                    <br />
                    Got them in the palm of your hand <br />
                  </p>
                  <p>
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/wLDnq3xydxM"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Silently you slip through the way <br />
                  ...
                  <p>
                    ...
                    <br />
                    Is it ever enough to have what you're waitin' for? ah ah ah
                    aah
                    <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/G-9A25sabDA"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
