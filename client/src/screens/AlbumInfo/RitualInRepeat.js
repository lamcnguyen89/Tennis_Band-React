  ...
  return (
    <BodyClassName className="background-album">
      <main className="container p-2 my-4">
        ...
        <h4>
          <a
            href="https://www.amazon.com/dp/B00LGQVFQK/ref=ntt_mus_ep_dpi_5"
            target="_blank"
            rel="noreferrer"
            alt="All Tennis's Music"
          >
            Purchase Ritual in Repeat Here!
          </a>
        </h4>
        <hr />
        <div className="row">
          ...
          <div className="col-8">
            <div className="tab-content" id="nav-tabContent">
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/-DNLfOzYIp4"
                    frameborder="0"
                ...
                <div className="container mt-3">
                  ...
                  <p>
                    ...
                    Of the heavens
                    <br />
                    So expansive in the waning light <br />
                  </p>
                  <p>
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/7Ef9UVjpLVE"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  ...
                  <p>
                    ...
                    I'll make him mine
                    <br />
                    Do whatever I can <br />
                  </p>
                  <p>
                    Got me looking for love
                    <br />
                    Got me looking for love <br />
                  </p>
                  <p>
                    Little sympathy
                    <br />
                    ...
                    <br />
                    That the first sign of love falls flat right where the cold
                    wind blows
                    <br />
                    A single syllable contains my history
                    <br />
                    Never know what word could mean so much to me <br />
                  </p>
                  <p>
                    Fell in love with the traveling man
                    <br />
                  ...
                  <p>
                    ...
                    <br />
                    You got me looking for love <br />
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <h3>Needle and a Knife</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/emP1LJe6fkA"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    She works hard <br />
                    Does it all without complainin'
                    <br />
                    She believes
                    <br />
                    That sacred things don't need explainin'
                    <br />
                  ...
                  <p>
                    She foresees
                    <br />
                    Apocalyptic curse will open
                    <br />
                    She believes
                    <br />
                    In something she can put her hope in
                    <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/No7pcsWPI5U"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Tonight I'll trace a fragile curve <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/9itLpoPZ-P8"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Even bad girls can do good things <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/XQhGCIkhElU"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Jot some things down on a list <br />
                  ...
                  <p>
                    A hard heart will make a man blind
                    <br />
              ...
              >
                <h3>Viv Without the N</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/4cHiifh9qpE"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  ...
                  <p>
                    ...
                    <br />
                    A classNameified to bring you home
                    <br />
              ...
              >
                ...
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/qcT2Vm-ky0g"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Here bring your wounded heart <br />
                  ...
                  <p>
                    ...
                    <br />
                    When my ideas are rushing pas mal
                    <br />
                    And your look does not bear a reproof
                    <br />
              ...
              >
                <h3>This Isn't My Song</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/K5K5QsVHGVA"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
              ...
              >
                <h3>Solar on the Rise</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/_Xc8VgxM2mE"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  ...
                  <p>
                    Dark [?] That throw their fragrance round
                    <br />
              ...
              <div
                ...
                id="song11"
                role="tabpanel"
                aria-labelledby="song11-list"
              >
                <h3>Meter and Line</h3>
                <div className="embed-responsive embed-responsive-16by9">
                  <iframe
                    className="embed-responsive-item rounded"
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/RlhahIEpMnk"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
                ...
                <div className="container mt-3">
                  <p>
                    Some things just slip from my mind <br />
                    Sweet memories leave me blind <br />
                  ...
                  <p>
                    ...
                    <br />
                    Drifting along the astral plane <br />
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <br />
                    Somethings just slip from my mind
                    <br />
                  </p>
                </div>
              </div>
